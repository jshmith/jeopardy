...
export const btnPrimary =
  'cursor-pointer rounded-xl bg-gradient-to-b from-crt-amber-light to-crt-amber px-5 py-2.5 font-semibold text-crt-bg shadow-md shadow-black/20 transition duration-150 hover:brightness-105 hover:shadow-lg active:scale-[0.98] disabled:opacity-40 disabled:pointer-events-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-crt-amber/70 focus-visible:ring-offset-2 focus-visible:ring-offset-crt-bg'

export const btnSecondary =
  'cursor-pointer rounded-xl bg-crt-cream/10 px-5 py-2.5 font-semibold text-crt-cream shadow-sm transition duration-150 hover:bg-crt-cream/15 active:scale-[0.98] disabled:opacity-40 disabled:pointer-events-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-crt-cream/40 focus-visible:ring-offset-2 focus-visible:ring-offset-crt-bg'

export const btnQuiet =
  'cursor-pointer rounded-lg px-3 py-1.5 text-sm text-crt-cream/60 transition duration-150 hover:bg-crt-cream/10 hover:text-crt-cream/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-crt-cream/30'

export const btnDanger =
  'cursor-pointer rounded-xl bg-red-600/90 px-5 py-2.5 font-semibold text-white shadow-md shadow-black/20 transition duration-150 hover:bg-red-600 active:scale-[0.98] disabled:opacity-40 disabled:pointer-events-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400/70'

export const btnCorrect =
  'cursor-pointer rounded-xl bg-gradient-to-b from-green-500 to-green-600 px-5 py-2.5 font-semibold text-white shadow-md shadow-black/20 transition duration-150 hover:brightness-105 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-300/60'

export const btnIncorrect =
  'cursor-pointer rounded-xl bg-gradient-to-b from-red-500 to-red-600 px-5 py-2.5 font-semibold text-white shadow-md shadow-black/20 transition duration-150 hover:brightness-105 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-300/60'
